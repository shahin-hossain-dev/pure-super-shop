    ...
    <div className="relative">
      ...
      {!isCartVisible && (
        <div
          ...
          className="fixed right-0 top-1/2 transform -translate-y-1/2 checkout-icon cursor-pointer text-white bg-[#84b93e] size-16 rounded-md text-center duration-500 ease-in-out"
        >
          0 Item
        </div>
      )}
